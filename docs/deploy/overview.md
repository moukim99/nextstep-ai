...
Nextstep supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Nextstep?** Use `local_trusted` (the default)
