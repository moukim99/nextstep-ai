...
- `NEXTSTEP_APPROVAL_ID` — the resolved approval
- `NEXTSTEP_APPROVAL_STATUS` — `approved` or `rejected`
- `NEXTSTEP_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
