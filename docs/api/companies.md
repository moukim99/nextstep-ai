...
Manage companies within your Nextstep instance.
...
Company logo uploads use the normal Nextstep attachment size limit.
...
| `logoUrl` | string | Optional Nextstep asset content path for the stored logo image |
