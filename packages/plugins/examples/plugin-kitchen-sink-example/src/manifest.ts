...
const manifest: NextstepPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Nextstep plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Nextstep",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Nextstep domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
