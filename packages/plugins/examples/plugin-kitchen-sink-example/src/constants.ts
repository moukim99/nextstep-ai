import type { PluginLauncherRegistration } from "@nextstepai/plugin-sdk";

export const PLUGIN_ID = "Nextstep-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".Nextstep-kitchen-sink-demo.txt",
} as const;
