...
import type { NextstepPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@nextstepai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: NextstepPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@nextstepai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
