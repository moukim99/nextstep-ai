/**
 * Bundling presets for Nextstep plugins.
 *
 ...
 * to match the Nextstep plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@nextstepai/plugin-sdk/ui",
    "@nextstepai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node20",
    sourcemap,
    external: ["@nextstepai/plugin-sdk"],
  };
