/**
 * Nextstep plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@nextstepai/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Nextstep navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Nextstep-internal path using the active company prefix.
   *
