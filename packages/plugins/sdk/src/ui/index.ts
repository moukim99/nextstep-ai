/**
 * `@nextstepai/plugin-sdk/ui` — Nextstep plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@nextstepai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@nextstepai/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Nextstep-internal links through the host router
