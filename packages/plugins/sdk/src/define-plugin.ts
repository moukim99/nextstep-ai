/**
 * `definePlugin` — the top-level helper for authoring a Nextstep plugin.
 *
...
// ---------------------------------------------------------------------------
// NextstepPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface NextstepPlugin {
 ...
 * @returns A sealed `NextstepPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@nextstepai/plugin-sdk";
