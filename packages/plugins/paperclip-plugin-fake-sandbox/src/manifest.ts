...
const PLUGIN_ID = "Nextstep.fake-sandbox-provider";
...
const manifest: NextstepPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Nextstep provider-plugin integration without external infrastructure.",
  author: "Nextstep",
