...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within NextstepPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Declares a normal Nextstep agent that a plugin can provision and later
...
export interface PluginManagedAgentDeclaration {
  ...
  /** Suggested Nextstep runtime configuration. */
...
/**
 * Declares a normal Nextstep project that a plugin can provision and later
 * resolve by stable key within each company.
 */
...
/**
 * Lower-bound semver requirement for the Nextstep host.
 *
...
export interface NextstepPluginManifestV1 {
   ...
   */
  minimumNextstepVersion?: PluginMinimumHostVersion;
