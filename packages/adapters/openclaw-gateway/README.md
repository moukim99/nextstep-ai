...
This document describes how `@nextstepai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Nextstep logs/transcript parsing
