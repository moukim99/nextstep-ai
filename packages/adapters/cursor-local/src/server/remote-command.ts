...
import { ensurePathInEnv } from "@nextstepai/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__NEXTSTEP_CURSOR_HOME__:";
  const preferredMarker = "__NEXTSTEP_CURSOR_AGENT__:";
  try {
