...
import type { PluginCategory, PluginStatus, NextstepPluginManifestV1 } from "@nextstepai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<NextstepPluginManifestV1>().notNull(),
