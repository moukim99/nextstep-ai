...
function resolveNextstepInstanceId(): string {
  const raw = process.env.NEXTSTEP_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveNextstepHomeDir(), "instances", resolveNextstepInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveNextstepHomeDir(), "instances", resolveNextstepInstanceId(), "data", "backups");
}
