...
export interface AdapterEnvironmentTestContext {
   ...
   *
   * If omitted (or `kind === "local"`), the adapter tests on the Nextstep
...
export interface AdapterRuntimeCommandSpec {
  /**
   * The command Nextstep should execute for this adapter in the current config.
   */
  command: string;
  /**
...
export interface ServerAdapterModule {
   ...
   * rather than reading config.NextstepRuntimeSkills.
   */
