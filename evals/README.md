...
Eval framework for testing Nextstep agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Nextstep heartbeat skill:
