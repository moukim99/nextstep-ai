...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" Nextstep doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `nextstepai configure --section database` or `nextstepai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadNextstepEnvFile(input.configPath);
