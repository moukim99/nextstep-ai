...
import type { ToolRunContext } from "@nextstepai/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@nextstepai/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<NextstepPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<NextstepPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @nextstep/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@nextstepai/plugin-hello-world-example",
    pluginKey: "Nextstep.hello-world-example",
  ...
  {
    packageName: "@nextstepai/plugin-file-browser-example",
    pluginKey: "Nextstep-file-browser-example",
  ...
  {
    packageName: "@nextstepai/plugin-kitchen-sink-example",
    pluginKey: "Nextstep-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current Nextstep plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
    localPath: "packages/plugins/examples/plugin-kitchen-sink-example",
    tag: "example",
  },
  {
    packageName: "@nextstepai/plugin-orchestration-smoke-example",
    pluginKey: "nextstepai.plugin-orchestration-smoke-example",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "Nextstep.claude-usage",
