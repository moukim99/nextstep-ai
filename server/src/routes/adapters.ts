 ...
 * toggle server-side adapter code for the whole Nextstep instance.
 *
...
interface AdapterInstallRequest {
  /** npm package name (e.g., "droid-Nextstep-adapter") or local path */
  packageName: string;
...
export function adapterRoutes() {
  ...
  // without modifying Nextstep's source code.
  //
