...
import { pluginManifestV1Schema, type NextstepPluginManifestV1 } from "@nextstepai/shared";
...
function manifest(apiRoutes: NonNullable<NextstepPluginManifestV1["apiRoutes"]>): NextstepPluginManifestV1 {
  return {
    id: "Nextstep.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
