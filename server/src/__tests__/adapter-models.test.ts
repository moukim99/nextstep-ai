...
import { models as codexFallbackModels } from "@nextstepai/adapter-codex-local";
import { models as cursorFallbackModels } from "@nextstepai/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@nextstepai/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@nextstepai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.NEXTSTEP_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.NEXTSTEP_OPENCODE_COMMAND = "__NEXTSTEP_missing_opencode_command__";
