...
import * as serverUtils from "@nextstepai/adapter-utils/server-utils";
export type { RunProcessResult } from "@nextstepai/adapter-utils/server-utils";
...
export const buildNextstepEnv = serverUtils.buildNextstepEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "NEXTSTEP_RESOLVED_COMMAND"] =
