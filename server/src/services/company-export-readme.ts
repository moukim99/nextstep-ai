 ...
 */
import type { CompanyPortabilityManifest } from "@nextstepai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Nextstep](https://Nextstep.ing)");
  lines.push("");
