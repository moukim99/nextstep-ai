...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@nextstepai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: NextstepPluginManifestV1, pluginDbId?: string): void;
