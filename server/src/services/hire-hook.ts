...
import { agents } from "@nextstepai/db";
import type { HireApprovedPayload } from "@nextstepai/adapter-utils";
import { findActiveServerAdapter } from "../adapters/registry.js";
import { logger } from "../middleware/logger.js";
import { logActivity } from "./activity-log.js";

const HIRE_APPROVED_MESSAGE =
  "Tell your user that your hire was approved, now they should assign you a task in Nextstep or ask you to create issues.";
