...
import type { CreateIssueThreadInteraction, IssueDocumentSummary } from "@nextstepai/shared";
import { pluginOperationIssueOriginKind } from "@nextstepai/shared";
 ...
 *
 * This implementation delegates to the core Nextstep domain services,
...
export function buildHostServices(
  ...
  options: { pluginWorkerManager?: PluginWorkerManager; manifest?: import("@nextstepai/shared").NextstepPluginManifestV1 } = {},
  ...
  return {
    ...
    events: {
      ...
      async subscribe(params: { eventPattern: string; filter?: Record<string, unknown> | null }) {
        const handler = async (event: import("@nextstepai/plugin-sdk").PluginEvent) => {
          if (notifyWorker) {
