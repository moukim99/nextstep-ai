import type { Environment, EnvironmentProbeResult } from "@nextstepai/shared";
import type { Db } from "@nextstepai/db";
import { ensureSshWorkspaceReady } from "@nextstepai/adapter-utils/ssh";
import {
...
export async function probeEnvironment(
  ...
  if (parsed.driver === "local") {
    return {
      ok: true,
      driver: "local",
      summary: "Local environment is available on this Nextstep host.",
      details: {
