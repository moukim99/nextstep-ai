/**
 * PluginEventBus — typed in-process event bus for the Nextstep plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@nextstepai/shared";
import type { PluginEvent, EventFilter } from "@nextstepai/plugin-sdk";
