...
This is intentionally separate from the normal Nextstep dev image.
...
```sh
review-checkout-pr nextstepai/nextstep 432
cd /work/checkouts/nextstepai-Nextstep/pr-432
```
...
## Preview the Nextstep app from the PR
...
- Nextstep's embedded PostgreSQL and local storage stay inside the container home volume via `NEXTSTEP_HOME=/home/reviewer/.Nextstep-review`.
