...
- installed adapter list for this Nextstep instance
...
## 8. New Skill: `Nextstep-create-agent`

Create new skill directory:

- `skills/Nextstep-create-agent/SKILL.md`
- `skills/Nextstep-create-agent/references/api-reference.md`
...
Also update `skills/Nextstep/SKILL.md` to reference this skill for hiring workflows.
...
- `Nextstep-create-agent` skill + docs updates
