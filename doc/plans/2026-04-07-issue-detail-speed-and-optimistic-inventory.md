...
This note inventories the Nextstep issues that point to the same UX class of problem:
...
Pattern: Nextstep already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
