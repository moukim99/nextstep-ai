...
- [ ] The first paragraph points at the Nextstep skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Nextstep execution contract verbatim:
...
- [ ] Adapter config matches this Nextstep instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
