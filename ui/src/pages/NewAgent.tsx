...
import { AGENT_ROLES, type AdapterEnvironmentTestResult } from "@nextstepai/shared";
...
import { DEFAULT_OPENCODE_LOCAL_MODEL, isValidOpenCodeModelId } from "@nextstepai/adapter-opencode-local";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("nextstepai/nextstep/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Nextstep runtime skills are added automatically.
              </p>
            </div>
