...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@nextstepai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Nextstep file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Nextstep storage.";
