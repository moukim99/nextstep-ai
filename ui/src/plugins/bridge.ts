 ...
 * `useHostContext` from `@nextstepai/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__NextstepPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Nextstep path to the active company scope.
 *
