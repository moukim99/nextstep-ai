 ...
 *
 * This is placed on `globalThis.__NextstepPluginBridge__` and consumed by
...
declare global {
  ...
  var __NextstepPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "Nextstep:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__NextstepPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__NextstepPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
