...
export const DISMISSED_KEY = "Nextstep:inbox:dismissed";
export const READ_ITEMS_KEY = "Nextstep:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "Nextstep:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "Nextstep:inbox:issue-columns";
export const INBOX_NESTING_KEY = "Nextstep:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "Nextstep:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "Nextstep:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "Nextstep:inbox:collapsed-groups";
