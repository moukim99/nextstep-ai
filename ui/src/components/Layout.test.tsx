...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Nextstep" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Nextstep" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Nextstep" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Nextstep" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Nextstep" },
