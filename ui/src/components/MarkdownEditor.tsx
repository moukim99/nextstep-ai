...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@nextstepai/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative Nextstep-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("Nextstep-mdxeditor", !bordered && "Nextstep-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "Nextstep-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
