...
import type { Agent, ExecutionWorkspace, Project } from "@nextstepai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/Nextstep/project-1",
      effectiveLocalFolder: "/tmp/Nextstep/project-1",
