...
export interface NextstepIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface NextstepIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: NextstepIssueRuntimeReassignment;
}

interface UseNextstepIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: NextstepIssueRuntimeSendOptions) => Promise<void>;
...
export function useNextstepIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseNextstepIssueRuntimeOptions) {
