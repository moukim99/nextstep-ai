...
function installStorybookApiFixtures() {
  ...
  const currentWindow = window as typeof window & {
    __NextstepStorybookFetchInstalled?: boolean;
  };
  if (currentWindow.__NextstepStorybookFetchInstalled) return;

  const originalFetch = window.fetch.bind(window);
  currentWindow.__NextstepStorybookFetchInstalled = true;
  ...
  window.fetch = async (input: RequestInfo | URL, init?: RequestInit) => {
    ...
    if (adapterSchemaMatch) {
      ...
      }).__NextstepStorybookAdapterSchemas;
...
const preview: Preview = {
  ...
  globalTypes: {
    theme: {
      description: "Nextstep color mode",
      defaultValue: "dark",
      toolbar: {
        title: "Theme",
        icon: "mirror",
