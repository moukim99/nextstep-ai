...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@nextstepai/shared";
...
import { createIssue, storybookAgents } from "../fixtures/nextstepData";
...
function Section({
  ...
  return (
    <section className="Nextstep-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="Nextstep-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/nextstepai/nextstep).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Nextstep secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @nextstepai/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "nextstepai/nextstep",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Nextstep" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    repoUrl: "https://github.com/nextstepai/nextstep",
    repoRef: "master",
    defaultRef: "master",
    repoName: "Nextstep",
    localFolder: "/Users/dotta/Nextstep",
    managedFolder: "Nextstep",
    effectiveLocalFolder: "/Users/dotta/Nextstep",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="Nextstep-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="Nextstep-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Nextstep form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Nextstep form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
