...
import type { Agent } from "@nextstepai/shared";
import {
  storybookAgents,
  ...
  storybookIssues,
  storybookProjects,
} from "../fixtures/nextstepData";

const COMPANY_ID = "company-storybook";
const SELECTED_COMPANY_STORAGE_KEY = "Nextstep.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "Nextstep:issue-draft";

const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: COMPANY_ID,
    title: "Build Nextstep",
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .nextstep/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/Nextstep",
    workspacePath: "/Users/dotta/Nextstep/.nextstep/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/nextstepai/nextstep");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/Nextstep/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Nextstep creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
