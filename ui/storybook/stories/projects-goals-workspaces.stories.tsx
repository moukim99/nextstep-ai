...
import type { Goal, Project } from "@nextstepai/shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="Nextstep-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="Nextstep-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("Nextstep-worktree-enabled", "true");
  setWorktreeMeta("Nextstep-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("Nextstep-worktree-color", "#0f766e");
  setWorktreeMeta("Nextstep-worktree-text-color", "#ecfeff");
        ...
        <main className="Nextstep-story__inner space-y-6">
          <section className="Nextstep-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="Nextstep-story__label">Projects, goals, and workspaces</div>
