...
import type { Agent, FeedbackVote, IssueComment } from "@nextstepai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/nextstepData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Nextstep work: checkout, comments, linked runs, and review feedback.",
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <ScenarioCard
            ...
            description="Issue is in planning mode. The composer turns amber and surfaces a Planning chip next to the Nextstep — clicking it stages a Standard submission without immediately changing the issue mode."
          >
            <IssueChatThread
              comments={[]}
              timelineEvents={[]}
...
function IssueThreadNoticeReview() {
  return (
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner max-w-4xl">
...
function ChatCommentsStories() {
  return (
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner space-y-6">
        <section className="Nextstep-story__frame p-6">
          <div className="Nextstep-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Nextstep operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
