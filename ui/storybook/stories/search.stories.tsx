...
import type { CompanySearchResult, CompanySearchResponse } from "@nextstepai/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/nextstepData";
...
function SearchStories() {
  return (
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner max-w-[1320px] space-y-6">
        <section className="Nextstep-story__frame p-6">
          <div className="Nextstep-story__label">Search</div>
        ...
        <section className="Nextstep-story__frame overflow-hidden">
          <div className="Nextstep-story__title-block">
            <div className="Nextstep-story__label">/search</div>
        ...
        <section className="Nextstep-story__frame overflow-hidden p-4">
          <div className="Nextstep-story__title-block">
            <div className="Nextstep-story__label">Match-source chips</div>
        ...
        <section className="Nextstep-story__frame overflow-hidden p-4">
          <div className="Nextstep-story__title-block">
            <div className="Nextstep-story__label">Cmd+K palette</div>
        ...
        <section className="Nextstep-story__frame overflow-hidden p-4">
          <div className="Nextstep-story__title-block">
            <div className="Nextstep-story__label">Search result row</div>
