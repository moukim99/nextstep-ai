...
import { storybookAgents, storybookIssues } from "../fixtures/nextstepData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        NEXTSTEP_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "Nextstep-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="Nextstep-story__inner space-y-6">
          <section className="Nextstep-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="Nextstep-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Nextstep fixtures.",
      },
    },
  },
