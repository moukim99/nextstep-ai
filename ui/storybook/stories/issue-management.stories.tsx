...
import type { Issue } from "@nextstepai/shared";
        ...
        <main className="Nextstep-story__inner space-y-6">
          <section className="Nextstep-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="Nextstep-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="Nextstep-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="Nextstep-story">
        <main className="Nextstep-story__inner space-y-6">
          <section className="Nextstep-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="Nextstep-story__label">IssueRunLedger</div>
