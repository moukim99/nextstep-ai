...
import type { HeartbeatRun, Issue } from "@nextstepai/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Nextstep Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII Nextstep field"}>
