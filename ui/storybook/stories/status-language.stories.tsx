...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@nextstepai/shared";
import type {
...
import { createIssue } from "../fixtures/nextstepData";
    ...
    <div className="Nextstep-story">
      <main className="Nextstep-story__inner space-y-6">
        <section className="Nextstep-story__frame p-6">
          <div className="Nextstep-story__label">Language</div>
