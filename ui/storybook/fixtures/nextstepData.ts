...
const storybookRepoRoot = "~/Nextstep";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.nextstep/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.nextstep/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Nextstep product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make Nextstep the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @nextstepai/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://Nextstep-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".nextstep/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/nextstepData.ts`.",
  ].join("\n"),
